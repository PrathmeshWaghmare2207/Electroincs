    ...
    public List<viewlist> getAllviewlist() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                v.setPdesc(rs.getString(6));
                v.setBname(rs.getString(8));
                v.setCname(rs.getString(10));
                listv.add(v);
...
//===================================================================================================================
    ...
    List<viewlist> listv = new ArrayList<>();

    try {
        String sql = "SELECT pname, pprice, pquantity, pimage, bname, cname, pdesc FROM viewlist WHERE pimage = ?";
        PreparedStatement ps = conn.prepareStatement(sql);
        ps.setString(1, st.trim());
        ResultSet rs = ps.executeQuery();
